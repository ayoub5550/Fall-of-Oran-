...
static TArray<FFOLevelDef> BuildCampaign()
{
	...
	// ------------------------------------------------------------ 2. Power station
	{
		...
		P.Location = FVector(7300, -480, 0); P.Yaw = 90.f; P.Size = 4; P.PenaltyZombies = 2;
	...
	// ------------------------------------------------------------ 3. Port
	{
		...
		P.Location = FVector(10000.f + 60.f, 330, 0); P.Yaw = 180.f; P.Size = 4; P.Code = TEXT("3714"); P.PenaltyZombies = 3;
