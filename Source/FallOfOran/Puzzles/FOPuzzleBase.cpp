...
void AFOPuzzleBase::BuildWorkLight()
{
	...
	// Keep the central approach lane free; the former tripod blocked direct use.
	MakeBox(FVector(-170.f, 160, 90.f), FVector(10.f, 10.f, 180.f), FLinearColor(0.08f, 0.08f, 0.09f));
	MakeBox(FVector(-170.f, 160, 8.f), FVector(70.f, 70.f, 16.f), FLinearColor(0.08f, 0.08f, 0.09f));
	MakeBox(FVector(-160.f, 160, 190.f), FVector(30.f, 44.f, 30.f), FLinearColor(0.1f, 0.1f, 0.11f), FLinearColor::Black, false);
	MakeBox(FVector(-144.f, 160, 190.f), FVector(3.f, 36.f, 24.f), Warm, Warm * 8.f, false);
	WorkLight = MakeLight(FVector(-120.f, 120, 200.f), Warm, 90.f, 1100.f);
